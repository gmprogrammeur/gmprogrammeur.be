...
<body>
	...
	<div class="w3-top">
	  <div class="w3-bar w3-blue w3-greyscale-min w3-text-black">
		...
		<a href="#projet" class="w3-bar-item w3-button w3-hide-small w3-hover-text-white"><i class="fa fa-th"></i> PROJET</a>
		<a href="#contact" class="w3-bar-item w3-button w3-hide-small w3-hover-text-white"><i class="fa fa-envelope"></i> CONTACT</a>
		<a href="nl.php" class="w3-bar-item w3-button w3-hide-small w3-hover-text-white">NL</a>
		<a href="en.php" class="w3-bar-item w3-button w3-hide-small w3-hover-text-white">EN</a>

	  </div>

	  <div class="w3-bar w3-light-blue w3-greyscale-min w3-text-black">

		<p class="w3-center">In Code We Trust !</p>
	  ...
	  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
		...
		<a href="nl.php" class="w3-bar-item w3-button" onclick="toggleFunction()">NL</a>
	...
	<div class="bgimg-1 w3-display-container" id="accueil">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-text-black w3-center w3-padding-large w3-light-blue w3-greyscale-min w3-xlarge w3-wide"><i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</h1>

	  </div>

	  <div class="w3-display-bottommiddle" style="white-space:nowrap; margin-bottom: 40px;">

		<a href="#apropos" class="w3-button w3-blue w3-greyscale-min w3-hover-text-white w3-text-black"><i class="fa fa-question"></i> A PROPOS <i class="fa fa-caret-down"></i></a>
	...
	<div class="w3-content w3-container w3-padding-64" id="apropos">
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large" style="margin-top: 50px;">
				...
				<p class="w3-large">Evénement: <a href="http://www.hackbelgium.be/" target="_blank">HackBelgium</a>, <a href="https://www.digitalfirst.be/index.php" target="_blank">Digital First</a>

				<br>

				Bénévolat: <a href="http://www.croix-rouge.be/" target="_blank">Croix-Rouge</a>

				<br>

				Expérience: <a href="http://www.becode.org/" target="_blank">BeCode</a>, <a href="http://www.croix-rouge.be/" target="_blank">Croix-Rouge</a>, <a href="http://www.gmprogrammeur.be/" target="_blank">GMProgrammeur</a>, <a href="http://www.verslalune.fr/" target="_blank">Vers la Lune</a>

				<br>

				Certificat: <a href="https://www.freecodecamp.org/gmprogrammeur/front-end-certification" target="_blank">Front End Development Certification</a>

				<br>
				
				Formation: <a href="http://www.becode.org/" target="_blank">BeCode</a>, <a href="https://www.freecodecamp.org/" target="_blank">freeCodeCamp</a></p>
			...
			<div class="w3-col m4 w3-padding-large w3-center">
				...
				<img src="Images/gmpho.jpg" class="w3-image w3-opacity-min w3-hover-opacity-off" alt="gm logo" style="width: 200px;">
		...
		<h3 class="w3-large w3-center">Compétences:</h3>
		...
		<div class="w3-center">
			...
			<a href="#projet" class="w3-button w3-blue w3-greyscale-min w3-hover-text-white w3-text-black"><i class="fa fa-th"></i> PROJET <i class="fa fa-caret-down"></i></a>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<h3 class="w3-center"><i class="fa fa-bullhorn w3-hover-text-grey"></i> OFFRE</h3>

		<p class="w3-center w3-large">Offres de <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-laptop w3-hover-text-grey"></i><br>Site vitrine</p>

		</div>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-cubes w3-hover-text-grey"></i><br>CMS (Indisponible)</p>

		</div>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-cart-arrow-down w3-hover-text-grey"></i><br>E-Commerce (Indisponible)</p>

		</div>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-gear w3-hover-text-grey"></i><br>Maintenance</p>
	...
	<div class="bgimg-2 w3-display-container" id="projet">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-light-blue w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-th w3-hover-text-grey"></i> Projet</h1>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h2 class="w3-center"><i class="fa fa-th w3-hover-text-grey"></i> PROJET</h2>

		<h3 class="w3-center w3-large">Voicis mes projets, du moins au plus récents</h3>
		...
		<br>
			...
			<div class="slideshow-container">
			  ...
			  <div class="mySlides fade">
				...
				<div class="text">1er projet: BeCode</div>
			  ...
			  <div class="mySlides fade">
				...
				<div class="text">2eme projet: Croix-Rouge de Belgique</div>
			  ...
			  <div class="mySlides fade">
				...
				<div class="text">3eme projet: GMProgrammeur</div>
			  ...
			  <div class="mySlides fade">
				...
				<div class="text">4eme projet: Vers la Lune</div>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<h3 class="w3-center"><i class="fa fa-line-chart w3-hover-text-grey"></i> STATISTIQUE</h3>

		<p class="w3-center w3-large">Statistiques de <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>

		<div class="w3-quarter w3-large">

			<p>2 <b>+</b><br>Formation</p>
		...
		<div class="w3-quarter w3-large">
			...
			<p>1 <b>+</b><br>Bénévolat</p>

		</div>

		<div class="w3-quarter w3-large">

			<p>2 <b>+</b><br>Evénement</p>
	...
	<div class="bgimg-3 w3-display-container" id="contact">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-light-blue w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-envelope w3-hover-text-grey"></i> Contact</h1>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large">Contactez moi en remplissant le formulaire ci-dessous</h3>
		...
		<div class="w3-row w3-padding-32 w3-section">
			...
			<div class="w3-col m8 w3-panel">
				...
				<div class="w3-large w3-margin-bottom">
					...
					<i class="fa fa-envelope fa-fw w3-hover-text-grey w3-xlarge w3-margin-right"></i>gmprogrammeur@gmail.com
				...
				<form action="" method="POST">
					...
					<button class="w3-button w3-blue w3-greyscale-min w3-right w3-section w3-text-black w3-hover-text-white" type="submit" name="submit">
	...
	<div class="w3-row w3-center w3-light-blue w3-text-black w3-padding-16">
		...
		<p class="w3-center w3-large">Partenaires de <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>
	...
	<div style="margin: 64px auto; text-align: center;">
		...
		<a href="https://www.000webhost.com/1031001.html" target="_blank"><img src="https://www.000webhost.com/images/banners/468x60/banner11.gif" alt="Web hosting" style="width: 468px; height: 60px;"/></a>

	</div>


	<!-- Footer -->
	<footer class="w3-center w3-light-blue w3-greyscale-min w3-padding-64">

	  <a href="#accueil" class="w3-button w3-blue w3-hover-grey w3-text-black w3-hover-text-white"><i class=" fa fa-laptop"></i> GMPROGRAMMEUR <i class="fa fa-caret-up"></i></a>

	  <p class="w3-center w3-large w3-text-black" style="margin-bottom: 0;"><i class="fa fa-laptop w3-hover-text-grey"></i> <i class="fa fa-tablet w3-hover-text-grey"></i> <i class="fa fa-mobile w3-hover-text-grey"></i><br><i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur <i class="fa fa-copyright w3-hover-text-grey"></i> 2017-2018</p>
