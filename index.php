...
<body>
	...
	<div class="w3-content w3-container w3-padding-64" id="apropos">
		...
		<h3 class="w3-center w3-large"><em>Geoffrey Marique<br>Programmeur | Développeur</em></h3>
		...
		<h3 class="w3-large w3-center"><em>Compétences:</em></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>Voicis mes projets, du moins au plus récents</em></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>Envoyez moi un message par email</em></h3>
