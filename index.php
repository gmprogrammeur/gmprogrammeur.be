...
<body>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large">Offres de GMProgrammeur</p>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large">Statistiques de GMProgrammeur</p>
	...
	<div class="w3-row w3-center w3-light-blue w3-text-black w3-padding-16">
		...
		<p class="w3-center w3-large">Partenaires de GMProgrammeur</p>
	...
	<footer class="w3-center w3-blue w3-greyscale-min w3-padding-64">
	  ...
	  <p class="w3-center w3-large w3-text-black" style="margin-bottom: 0;"><i class="fa fa-laptop w3-hover-text-grey"></i> <i class="fa fa-tablet w3-hover-text-grey"></i> <i class="fa fa-mobile w3-hover-text-grey"></i><br>GMProgrammeur <i class="fa fa-copyright w3-hover-text-grey"></i> 2017</p>
