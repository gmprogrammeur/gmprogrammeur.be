...
<body>
	...
	<div class="bgimg-1 w3-display-container" id="accueil">
	  ...
	  <div class="w3-display-bottommiddle" style="white-space:nowrap; margin-bottom: 40px;">
		...
		<a href="#apropos" class="w3-button w3-blue w3-greyscale-min w3-hover-text-white w3-text-black"><i class="fa fa-question"></i> ABOUT ME <i class="fa fa-caret-down"></i></a>
	...
	<div class="w3-content w3-container w3-padding-64" id="apropos">
		...
		<h3 class="w3-center w3-large">Geoffrey Marique<br>Programmer | developer</h3>

		<p class="w3-large w3-center">Passionate about the computer and technological world, mainly the creation of Internet site (Responsive), I am always motivated to carry out new projects, to do this, I inform myself and train myself continuously.</p>
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large" style="margin-top: 50px;">
				...
				Volunteer: <a href="http://www.croix-rouge.be/" target="_blank">Croix-Rouge</a>

				<br>

				Experience: <a href="http://www.becode.org/" target="_blank">BeCode</a>, <a href="http://www.croix-rouge.be/" target="_blank">Croix-Rouge</a>, <a href="http://www.gmprogrammeur.be/" target="_blank">GMProgrammeur</a>, <a href="http://www.verslalune.fr/" target="_blank">Vers la Lune</a>

				<br>

				Certificate: <a href="https://www.freecodecamp.org/gmprogrammeur/front-end-certification" target="_blank">Front End Development Certification</a>

				<br>
				
				Training: <a href="http://www.becode.org/" target="_blank">BeCode</a>, <a href="https://www.freecodecamp.org/" target="_blank">freeCodeCamp</a></p>
		...
		<h3 class="w3-large w3-center">Skills:</h3>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<h3 class="w3-center"><i class="fa fa-bullhorn w3-hover-text-grey"></i> OFFER</h3>

		<p class="w3-center w3-large">Offers from <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>
		...
		<div class="w3-quarter w3-large">
			...
			<p><i class="fa fa-cubes w3-hover-text-grey"></i><br>CMS (Unavailable)</p>

		</div>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-cart-arrow-down w3-hover-text-grey"></i><br>E-Commerce (Unavailable)</p>
	...
	<div class="bgimg-2 w3-display-container" id="projet">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-light-blue w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-th w3-hover-text-grey"></i> Project</h1>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large">Voicis my projects, at least to the most recent</h3>
	...
	<div class="w3-row w3-center w3-light-blue w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<h3 class="w3-center"><i class="fa fa-line-chart w3-hover-text-grey"></i> STATISTICAL</h3>

		<p class="w3-center w3-large">Statistics of <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>

		<div class="w3-quarter w3-large">

			<p>2 <b>+</b><br>Training</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large">Contact me by filling out the form below</h3>
	...
	<div class="w3-row w3-center w3-light-blue w3-text-black w3-padding-16">
		...
		<p class="w3-center w3-large">Partners of <i class="fa fa-laptop w3-hover-text-grey"></i> GMProgrammeur</p>
