...
<body>
	...
	<div class="w3-content w3-container w3-padding-64" id="apropos">
		...
		<h3 class="w3-center w3-large"><em>Geoffrey Marique<br>Programmer | developer</em></h3>
		...
		<h3 class="w3-large w3-center"><em>Skills:</em></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>Voicis my projects, at least to the most recent</em></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>Send me a message by email</em></h3>
