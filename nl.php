...
<body>
	...
	<div class="w3-content w3-container w3-padding-64" id="apropos">
		...
		<h3 class="w3-large w3-center">Vaardigheden:</h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large">Voicis mijn projecten, althans tot de meest recente</h3>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large">Neem contact met mij op door het onderstaande formulier in te vullen</h3>
